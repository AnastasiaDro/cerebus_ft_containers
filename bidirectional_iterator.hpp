    ...
    private:
        ...
        void setnext() {
            if (!node_ptr) {
                node_ptr = root;
                if (node_ptr) {
                    while (node_ptr->node_left)
                        node_ptr = node_ptr->node_left;
                }
                return;
            }
            if (node_ptr->node_right) {
                node_ptr = node_ptr->node_right;
                while (node_ptr->node_left)
                    node_ptr = node_ptr->node_left;
            } else {
                while (node_ptr->node_parent && node_ptr == node_ptr->node_parent->node_right)
                    node_ptr = node_ptr->node_parent;
                node_ptr = node_ptr->node_parent;
            }
        }
        ...
        void setprev() {
            if (!this->node_ptr) {
                node_ptr = root;
                if (node_ptr) {
                    while (node_ptr->node_right)
                        node_ptr = node_ptr->node_right;
                }
                return;
            }
            if (node_ptr->node_left) {
                node_ptr = node_ptr->node_left;
                while (node_ptr->node_right)
                    node_ptr = node_ptr->node_right;
            } else {
